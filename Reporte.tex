...
\usepackage{float}
\usepackage[colorlinks= true, urlcolor=blue, citecolor = black, filecolor=black, linkcolor= black]{hyperref}
...
\begin{wrapfigure}{l}{4cm}
    \centering
    \vspace{-2cm}
   \hspace{-1cm} \includegraphics[width=4cm]{logo.png}
\end{wrapfigure}

\hspace{2,5cm} \textbf{Reporte de trabajo} \hfill
